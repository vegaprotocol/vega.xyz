        ...
        <ScrollSpy>
          ...
          <div id="better">
            ...
            >
              <p>
                <Trans t={t}>
                  ...
                  anyone can propose a market on any underlying and the
                  community decides what gets created (unlike other
            ...
            >
              <p>
                <Trans t={t}>
                  Vega's cross margining and portfolio risk evaluation
                  innovations significantly lower capital costs opening up
                  hedging instruments to a far greater range of people and
                  businesses and allowing markets to exist that previously
                  wouldn't due to cost.
                </Trans>
              </p>
              <p>
                <Trans t={t}>
                  ...
                  instruments might reasonably incur - live, and on-chain,
                  instead of over the course of one trading day.
                </Trans>
              </p>
              <p>
                <Trans t={t}>
                  Built-in live, automated cross margining routes a trader's
                  gains made on one market to offset positions on other markets.
                </Trans>
              </p>
              <div className="title-xxs !font-not-glitched mt-8 mb-4 text-black dark:text-white">
                <Trans t={t}>Read more about:</Trans>
            ...
            >
              <p>
                <Trans t={t}>
                  ...
                  fees, allowing better price discovery. What's more, Vega
                  offers subsecond latency together with price protection
            ...
            >
              <p>
                <Trans t={t}>
                  ...
                  manages credit risk more efficiently than centralised
                  exchanges. A plugin-like architecture for risk models and
                  best-in-class stochastic models that run fast enough to
                  support frequent margin evaluations allows traders with
                  positions to adjust quickly.
                </Trans>
              </p>
              <div className="title-xxs !font-not-glitched mt-8 mb-4 text-black dark:text-white">
                <Trans t={t}>Read more about:</Trans>
            ...
            >
              <p>
                <Trans t={t}>
                  ...
                  while removing concerns about latency and reducing the number
                  of manual transactions needed to maintain liquidity provider
                  orders.
                </Trans>
              </p>
              <div className="title-xxs !font-not-glitched mt-8 mb-4 text-black dark:text-white">
            ...
            >
              <p>
                <Trans t={t}>
                  ...
                  centrally control what can be traded. With Vega, everything
                  from the order book to market creation and maintenance,
                  liquidity provision and rewards, prices, management of margin
                  and how that position eventually settles happen on chain as
                  part of the network - all of it is managed and governed by the
                  community. This is trading with full transparency - and no
                  black boxes - doing away with the risks that come with
            ...
            >
              <p>
                <Trans t={t}>
                  Vega does not charge gas fees. It uses a different fee
                  structure that rewards participants and stimulates trading
                  activity. Fees are incurred on every trade on a market in
                  continuous trading, but it is the price taker who pays the
                  fee. During a market's opening auction, no fees are collected.
                </Trans>
              </p>
              <div className="title-xxs !font-not-glitched mt-8 mb-4 text-black dark:text-white">
                <Trans t={t}>Read more about:</Trans>
              ...
              <p className="text-base">
                <Trans t={t}>
                  Gas fees under 'Miner extractable value (MEV) on blockchains'
                  on the blog{' '}
                  <TextLink
            ...
            >
              <p>
                <Trans t={t}>
                  ...
                  trades will be able to settle in any crypto-asset on a
                  supported chain, paving the way for physically settled and
                  cash settled products, as commodity and asset tokenisation
                  become widespread.
                </Trans>
              </p>
              <div className="title-xxs !font-not-glitched mt-8 mb-4 text-black dark:text-white">
              ...
              <p className="text-base">
                <Trans t={t}>
                  Cross chain support and multi-chain collateral in the Vega
                  paper
                  <TextLink
            ...
            >
              ...
              <p>
                <Trans t={t}>
                  ...
                  data and Vega Pennant for simple graphs you could easily
                  create responsive markets to monitor real world/spot dynamics
                  and automatically propose a hedging market when volatility
                  exceeds a threshold.
                </Trans>
              </p>
            </BlockD>
