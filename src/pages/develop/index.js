...
const DevelopPage = ({ data }) => {
  ...
  return (
    <Layout>
        ...
        <div className="mb-16 pt-6 lg:pt-16">
          <div className="md:grid md:grid-cols-12">
            ...
            <div className="relative col-span-6 col-start-7 row-span-full md:mt-0">
              <div className="md:translate-x-20 md:translate-y-12 md:scale-125 lg:translate-x-1/4 lg:scale-150">
                <Wormhole />
              </div>
            </div>
          </div>
      ...
      <PageSection>
        <div className="relative px-16 pt-16 text-center md:pt-32">
          <video
            autoPlay
            muted
            loop
          ...
          <div className="relative">
            <h2 className="title-l md:title-xl lg:title-xxl mx-auto mb-4 max-w-[45rem]">
              <Trans t={t}>Join the Builders Club</Trans>
            </h2>
            <p className="copy-xs md:copy-s mx-auto max-w-[45rem] text-white">
              <Trans t={t}>
