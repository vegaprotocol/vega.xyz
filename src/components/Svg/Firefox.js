    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop stopColor="#b11927" stop-opacity=".74" offset=".351" />
          <stop stopColor="#db293d" stop-opacity=".343" offset=".435" />
          <stop stopColor="#f5334b" stop-opacity=".094" offset=".497" />
          <stop stopColor="#ff3750" stop-opacity="0" offset=".53" />
        </radialGradient>
        <radialGradient
          id="firefoxD"
          cx="-7927"
        ...
        <radialGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#9059ff" stop-opacity="0" offset=".206" />
          <stop stopColor="#8c4ff3" stop-opacity=".064" offset=".278" />
          <stop stopColor="#7716a8" stop-opacity=".45" offset=".747" />
          <stop stopColor="#6e008b" stop-opacity=".6" offset=".975" />
        </radialGradient>
        <radialGradient
          id="firefoxG"
          cx="-7938"
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#fff44f" stop-opacity=".8" offset=".167" />
          <stop stopColor="#fff44f" stop-opacity=".634" offset=".266" />
          <stop stopColor="#fff44f" stop-opacity=".217" offset=".489" />
          <stop stopColor="#fff44f" stop-opacity="0" offset=".6" />
        </linearGradient>
      </defs>
