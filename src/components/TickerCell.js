...
const TickerCell = ({ title, value, text, link }) => {
  return (
    <div className="px-6 py-4 pr-16 border-l border-r-0 border-current min-w-[12.5rem] flex items-center">
      <div>
        {title && (
        ...
        {value && (
          <div className="mt-1 text-[1.875rem] leading-none">{value}</div>
        )}

        {text && (
          <div className="text-[1.875rem] leading-none uppercase">
